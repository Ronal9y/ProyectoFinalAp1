...
{
    /// <inheritdoc />
    public partial class TiendaMascotas5 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cantidad = table.Column<int>(type: "int", nullable: false),
                    ProductoId = table.Column<int>(type: "int", nullable: false),
                    UsuariosUsuarioId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticuloMascotas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArticuloMascotas_Carritos_CarritoId",
                        column: x => x.CarritoId,
                        principalTable: "Carritos",
                        principalColumn: "CarritoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticuloMascotas_Mascotas_MascotaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticuloMascotas_CarritoId",
                table: "ArticuloMascotas",
                column: "CarritoId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticuloMascotas_MascotaId",
                table: "ArticuloMascotas",
                column: "MascotaId");
